 ...
 */
#ifndef PSODA_GREATER_THAN_OR_EQUAL_OP_H
#define PSODA_GREATER_THAN_OR_EQUAL_OP_H
 ...
 */
class GreaterThanOrEqualOp : public Operator {
 ...
 public:
   ...
   * Destructor
   */
  virtual ~GreaterThanOrEqualOp();

  /**
   * Returns true if operand1 >= operand2
   *
   * @param operand1, operand2 The operands on which to operate
   * @return a Literal with result
   */
