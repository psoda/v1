 ...
 */
#ifndef PSODA_MOD_OP_H
#define PSODA_MOD_OP_H
...
/**
 * Represents a mod (modulus) operator
 */
class ModOp : public Operator {
 ...
 public:
   ...
   */
  IntLiteral& operateOn(Environment* curEnv, Expression* operand1, Expression* operand2);
