 ...
 */
#ifndef PSODA_INEQUALITY_OP_H
#define PSODA_INEQUALITY_OP_H
 ...
 */
class InequalityOp : public Operator {

 private:

  /**
   * We will just return the oposite of what the equality operator says
   */
 ...
 public:
  ...
  /**
   * Returns true if operand1 != operand2; false otherwise
   *
