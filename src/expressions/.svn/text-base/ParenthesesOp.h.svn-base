 ...
 */
#ifndef PSODA_PARENTHESES_OP_H
#define PSODA_PARENTHESES_OP_H
 ...
 * This operator does nothing but represents nesting that requires parenthses
 * Using this operator will only affect the way things are printed
 */
class ParenthesesOp : public Operator {
 ...
 public:
   ...
   * Destructor
   */
  virtual ~ParenthesesOp();

  /**
   * Returns operand1->evaluate()
   *
   * @param operand1, operand2 The operands on which to operate
   * @return a Literal with the value operand1 evaluated
   */
