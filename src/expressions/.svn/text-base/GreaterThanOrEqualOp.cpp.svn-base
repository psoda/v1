...
GreaterThanOrEqualOp::GreaterThanOrEqualOp() : Operator() {
  return;
}
...
Literal& GreaterThanOrEqualOp::operateOn(Environment* curEnv, Expression* operand1, Expression* operand2) {
  assert(operand1);
  assert(operand2);
...
string GreaterThanOrEqualOp::getOpSymbol() const {
  return ">=";
}
