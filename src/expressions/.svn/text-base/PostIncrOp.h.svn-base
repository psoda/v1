 ...
 */
#ifndef PSODA_POST_INCR_OP_H
#define PSODA_POST_INCR_OP_H
 ...
 */
class PostIncrOp : public Operator {
 ...
 public:
  ...
  /**
   * Returns the post incremented value of operand1 (operand2 is ignored)
   *
