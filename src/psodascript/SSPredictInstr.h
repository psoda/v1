 ...
 */
#ifndef PSODA_SSPREDICT_INSTR_H
#define PSODA_SSPREDICT_INSTR_H

#include "AlignmentCommand.h"

using namespace std;

class SSPredictInstr : public AlignmentCommand {

 private:

  //Prohibit copying of this object
  void operator =(SSPredictInstr&);
 ...
 public:
  ...
  /**
   * Predict secondary structure for the sequences data
   */
  void doSSPredict(Environment* env);
