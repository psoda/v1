 ...
 */
#ifndef PSODA_PERCENT_IDENTITY_INSTR_H
#define PSODA_PERCENT_IDENTITY_INSTR_H

#include "AlignmentCommand.h"

using namespace std;

class PercentIdentityInstr : public AlignmentCommand {

 private:

  //Prohibit copying of this object
  void operator =(PercentIdentityInstr&);
 ...
 public:
   ...
   * Constructor
   */
  PercentIdentityInstr();

  /**
   * Destructor
   */
  virtual ~PercentIdentityInstr();

  /**
   * Call passParams() to set up the parameters in the interpreter
   * and executes the alignment
   */
  ...
  virtual string getName() const;
	  ...
	  void doPercentIdentity(Environment* env);
