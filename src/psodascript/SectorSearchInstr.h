 ...
 */
#ifndef PSODA_SECTOR_SEARCH_INSTR_H
#define PSODA_SECTOR_SEARCH_INSTR_H
...
class SectorSearchInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(SectorSearchInstr&);
