 ...
 */
#ifndef PSODA_DIRECTORY_LISTING_INSTR_H
#define PSODA_DIRECTORY_LISTING_INSTR_H
...
class DirectoryListingInstr : public BuiltInCommand {
 ...
 public:
   ...
   * Constructor
   */
  DirectoryListingInstr();

  /**
   * Destructor
   */
  virtual ~DirectoryListingInstr();
