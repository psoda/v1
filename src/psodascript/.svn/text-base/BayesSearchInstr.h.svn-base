 ...
 */
#ifndef PSODA_BAYES_SEARCH_INSTR
#define PSODA_BAYES_SEARCH_INSTR

#include "BuiltInCommand.h"

using namespace std;

class BayesSearchInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(BayesSearchInstr&);
 ...
 public:
   ...
   * Destructor
   */
  virtual ~BayesSearchInstr();

  /**
   * Execute a Bayes Search
   */
