 ...
 */
#ifndef PSODA_WEIGHTS_RESET_INSTR_H
#define PSODA_WEIGHTS_RESET_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class WeightsResetInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(WeightsResetInstr&);
