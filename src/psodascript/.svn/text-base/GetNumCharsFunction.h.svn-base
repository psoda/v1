 ...
 */
#ifndef PSODA_GET_NUM_CHARS_FUNCTION_H
#define PSODA_GET_NUM_CHARS_FUNCTION_H
...
/**
 * Function returns a the number of chars in the dataset taxa
 */
class GetNumCharsFunction : public BuiltInCommand {
