 ...
 */
#ifndef PSODA_SSALIGN_INSTR_H
#define PSODA_SSALIGN_INSTR_H

#include "AlignmentCommand.h"

using namespace std;

class SSAlignInstr : public AlignmentCommand {

 private:

  //Prohibit copying of this object
  void operator =(SSAlignInstr&);
 ...
 public:
  ...
  /**
   * Align the sequences data (using secondary structure)
   */
  void doSSAlign(Environment* env);
