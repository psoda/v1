 ...
 */
#ifndef PSODA_CHECK_PARSIMONY_INSTR_H
#define PSODA_CHECK_PARSIMONY_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class CheckParsimonyInstr : public BuiltInCommand {
	
	private: 
	void operator=(CheckParsimonyInstr&);
  ...
  virtual void execute(Environment* baseEnv, Literal*& returnVal);
	...
	void doCheckParsimony(Environment* env);
