 ...
 */
#ifndef PSODA_NEIGHBOR_TEST_INSTR_H
#define PSODA_NEIGHBOR_TEST_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class NeighborTestInstr : public BuiltInCommand {
	
	private: 
	void operator=(NeighborTestInstr&);
  ...
  virtual void execute(Environment* baseEnv, Literal*& returnVal);
	...
	bool doNeighborTest(Environment* env);
};
