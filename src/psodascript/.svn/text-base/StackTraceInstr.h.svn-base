 ...
 */
#ifndef PSODA_STACK_TRACE_INSTR_H
#define PSODA_STACK_TRACE_INSTR_H
...
class StackTraceInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(StackTraceInstr&);
 ...
 public:
   ...
   * Destructor
   */
  virtual ~StackTraceInstr();

  /**
   * Call passParams() to set up the parameters in the StackTraceer
   */
