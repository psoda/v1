 ...
 */
#ifndef PSODA_RANDOM_MORPH_INSTR_H
#define PSODA_RANDOM_MORPH_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class RandomMorphInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(RandomMorphInstr&);
