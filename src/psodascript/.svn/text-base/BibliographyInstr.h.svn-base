 ...
 */
#ifndef PSODA_BIBLIOGRAPHY_INSTR_H
#define PSODA_BIBLIOGRAPHY_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class BibliographyInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(BibliographyInstr&);
