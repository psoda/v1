 ...
 */
#ifndef PSODA_SUM_OF_PAIRS_INSTR_H
#define PSODA_SUM_OF_PAIRS_INSTR_H

#include "AlignmentCommand.h"

using namespace std;

class SumOfPairsInstr : public AlignmentCommand {

 private:

  //Prohibit copying of this object
  void operator =(SumOfPairsInstr&);
 ...
 public:
   ...
   * Sum of pairs metric
   */
  void doSumOfPairs(Environment* env);
  


};

#endif /* PSODA_SUM_OF_PAIRS_INSTR_H */
