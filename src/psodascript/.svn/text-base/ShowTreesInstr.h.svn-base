 ...
 */
#ifndef PSODA_SHOWTREES_INSTR_H
#define PSODA_SHOWTREES_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class ShowTreesInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  ShowTreesInstr& operator = (ShowTreesInstr&);
