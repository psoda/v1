 ...
 */
#ifndef PSODA_GET_WEIGHTS_LENGTH_FUNCTION_H
#define PSODA_GET_WEIGHTS_LENGTH_FUNCTION_H
...
/**
 * Function returns the length of the Weights in the dataset (the length of the compressed matrix)
 */
class GetWeightsLengthFunction : public BuiltInCommand {
 ...
 public:
   ...
   * Constructor
   */
  GetWeightsLengthFunction();
  
  /**
   * Destructor
   */
  virtual ~GetWeightsLengthFunction();
