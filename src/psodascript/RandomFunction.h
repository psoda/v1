 ...
 */
#ifndef PSODA_RANDOM_FUNCTION_H
#define PSODA_RANDOM_FUNCTION_H
...
/**
 * Function returns a random int between 0 and "max" exclusive
 */
class RandomFunction : public BuiltInCommand {
