 ...
 */
#ifndef PSODA_HSEARCH_INSTR_H
#define PSODA_HSEARCH_INSTR_H
...
class HSearchInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(HSearchInstr&);
 ...
 public:
  ...
  void doHeuristicSearch(Environment* env,QTreeRepository* treeRepository);
