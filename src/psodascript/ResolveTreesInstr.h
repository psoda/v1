 ...
 */
#ifndef PSODA_TREE_RESOLVE_INSTR_H
#define PSODA_TREE_RESOLVE_INSTR_H
...
class ResolveTreesInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(ResolveTreesInstr&);
