 ...
 */
#ifndef PSODA_SAVETREES_INSTR_H
#define PSODA_SAVETREES_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class SaveTreesInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(SaveTreesInstr&);
