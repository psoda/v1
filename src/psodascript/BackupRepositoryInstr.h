 ...
 */
#ifndef PSODA_BACKUP_REPOSITORY_INSTR_H
#define PSODA_BACKUP_REPOSITORY_INSTR_H

#include "BuiltInCommand.h"

using namespace std;

class BackupRepositoryInstr : public BuiltInCommand {

 private:

  //Prohibit copying of this object
  void operator =(BackupRepositoryInstr&);
 ...
 public:
   ...
   * Constructor
   */
  BackupRepositoryInstr();

  /**
   * Destructor
   */
  virtual ~BackupRepositoryInstr();
