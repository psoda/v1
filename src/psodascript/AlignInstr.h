 ...
 */
#ifndef PSODA_ALIGN_INSTR_H
#define PSODA_ALIGN_INSTR_H

#include "AlignmentCommand.h"

using namespace std;

class AlignInstr : public AlignmentCommand {

 private:

  //Prohibit copying of this object
  void operator =(AlignInstr&);
 ...
 public:
  ...
  /**
   * Align the sequences data
   */
  Dataset* doAlign(Environment* env);
