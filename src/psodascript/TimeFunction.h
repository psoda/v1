 ...
 */
#ifndef PSODA_TIME_FUNCTION_H
#define PSODA_TIME_FUNCTION_H
...
/**
 * Function returns an IntLiteral representing the system clock time in seconds
 */
class TimeFunction : public BuiltInCommand {
