...
@version AWT 1.120 -- last modified: 02/17/02
...
class ATVgraphic extends Canvas {
    ...
    */
    ...
    void setPropertiesForPainting( Tree t ) {
        ...
        if ( t != null && !t.isEmpty() ) {
            ...
            if ( t.getHighestLnL() != -Double.MAX_VALUE
            &&   t.getLowestLnL()  != +Double.MAX_VALUE
            &&   t.getLowestLnL()  != t.getHighestLnL() ) {
    ...
    */
    void smallFonts() {
        small_font        = new Font( "SansSerif", Font.PLAIN,  9 );
        large_font        = new Font( "SansSerif", Font.PLAIN,  10 );
        small_italic_font = new Font( "SansSerif", Font.ITALIC, 9 );
