 ...
 */
#ifndef PSODA_VARIABLE_REDECLARATION_EXCEPTION
#define PSODA_VARIABLE_REDECLARATION_EXCEPTION
 ...
 */
class VariableRedeclarationException : public PsodaException {
 ...
 public:
  ...
  VariableRedeclarationException(string _msg);
  VariableRedeclarationException(const PsodaException& other);

  /**
   * Destructor
   */
  virtual ~VariableRedeclarationException();
