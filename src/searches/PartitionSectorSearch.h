 ...
 */
#ifndef PSODA_PARTITION_SECTOR_SEARCH 
#define PSODA_PARTITION_SECTOR_SEARCH
...
class PartitionSectorSearch : public SectorSearchBase
{
  public:
    PartitionSectorSearch();
    virtual ~PartitionSectorSearch();
