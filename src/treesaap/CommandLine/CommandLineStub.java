/**
 *	CommandLineStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of the CommandLine program.
 *	
 *	@author	Joshua Sailsbery
 *	@version	2.0
 *	@since	1.0
 */
package treesaap.CommandLine;

import java.io.IOException;
import java.util.StringTokenizer;

public class CommandLineStub extends treesaap.Objects.Stub
{
	//Class Variables - Created Objects
	private CommandLineUsageBean bean;		//Bean created and populated by this class
	 ...
	 */
	public CommandLineStub(String user_settingsFileName) throws IOException
	{
		//create a new usage bean
		bean = new CommandLineUsageBean();
	 ...
	 */
	public CommandLineStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new CommandLineUsageBean();
	...
	/**
	 *  Get method - returns CommandLineUsageBean bean
	 */
