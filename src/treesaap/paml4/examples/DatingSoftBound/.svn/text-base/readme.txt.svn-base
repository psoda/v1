...
4 October 2005, modified in March 2007

You can use the files in this folder to run mcmctree to duplicate the
results of Yang and Rannala (2006: table 3) and Rannala and Yang
(2007, table table 2).  See the section on mcmctree in the paml
manual for a description of the program.
