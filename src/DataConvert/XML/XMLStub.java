/**
 *	XMLStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of XML algorithms.
 *	
...
class XMLStub extends DataConvert.Components.Stub
{
	//Class Variables - Created Objects
	private XMLUsageBean bean;		//Bean created and populated by this class
	 ...
	 */
	public XMLStub(String user_settingsFileName) throws IOException
	{
	 ...
	 */
	public XMLStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new XMLUsageBean();
	...
	{		
		...
		outputString += "[ XML User Input Values ]\n\n";
		return outputString;
	}//writeData
