/**
 *	XMLUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the XMLXML package.
 *	
...
class XMLUsageBean extends DataConvert.Components.UsageBean
{
