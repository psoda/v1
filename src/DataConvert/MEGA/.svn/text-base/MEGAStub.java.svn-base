/**
 *	MEGAStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of MEGA algorithms.
 *	
...
class MEGAStub extends DataConvert.Components.Stub
{
	//Class Variables - Created Objects
	private MEGAUsageBean bean;		//Bean created and populated by this class
	 ...
	 */
	public MEGAStub(String user_settingsFileName) throws IOException
	{
	 ...
	 */
	public MEGAStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new MEGAUsageBean();
