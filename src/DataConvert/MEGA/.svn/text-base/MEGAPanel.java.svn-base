...
class MEGAPanel extends ActionPanel
{	
	//Class Vars
	MEGAUsageBean bean;			//Bean of MEGA object
	 ...
	 */
	public MEGAPanel(MEGAUsageBean Bean)
	{
		bean = Bean;
		createObjects();
	}
	...
	public void create()
	{
		...
		setTabName("MEGA");
		setIconName("megaIcon.gif");
		setToolTip("MEGA File Format Options");
