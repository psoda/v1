/**
 *	MEGAUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the MEGA package.
 *	
...
class MEGAUsageBean extends DataConvert.Components.UsageBean
{
