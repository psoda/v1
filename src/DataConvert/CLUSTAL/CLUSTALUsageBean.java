/**
 *	CLUSTALUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the CLUSTAL package.
 *	
...
class CLUSTALUsageBean extends DataConvert.Components.UsageBean
{
