/**
 *	CLUSTALStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of CLUSTAL algorithms.
 *	
...
class CLUSTALStub extends DataConvert.Components.Stub
{
	//Class Variables - Created Objects
	private CLUSTALUsageBean bean;		//Bean created and populated by this class
	 ...
	 */
	public CLUSTALStub(String user_settingsFileName) throws IOException
	{
	 ...
	 */
	public CLUSTALStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new CLUSTALUsageBean();
