...
class CLUSTALPanel extends ActionPanel
{	
	//Class Vars
	CLUSTALUsageBean bean;			//Bean of CLUSTAL object
	 ...
	 */
	public CLUSTALPanel(CLUSTALUsageBean Bean)
	{
		bean = Bean;
		createObjects();
	}
	...
	public void create()
	{
		...
		setTabName("CLUSTAL");
		setIconName("clustalIcon.gif");
		setToolTip("CLUSTAL File Format Options");
