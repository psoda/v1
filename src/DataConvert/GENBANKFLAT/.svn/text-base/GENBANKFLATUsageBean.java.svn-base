/**
 *	GENBANKFLATUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the GENBANKFLATGENBANKFLAT package.
 *	
...
class GENBANKFLATUsageBean extends DataConvert.Components.UsageBean
{
	//DEFAULT VARIABLES - all values to be changed as read in from file
	private boolean hard_return;				//Whether to look for a return after name or not
	 ...
	 */
	public void setHard_return(boolean Hard_return)
	{
	 ...
	 */
	public boolean getHard_return()
	{
		return hard_return;
	}
}//GENBANKFLATUsageBean
