...
class PHYLIPPanel extends ActionPanel
{	
	//Class Vars
	PHYLIPUsageBean bean;			//Bean of PHYLIP object
	 ...
	 */
	public PHYLIPPanel(PHYLIPUsageBean Bean)
	{
		bean = Bean;
		createObjects();
	}
	...
	public void create()
	{
		...
		setTabName("PHYLIP");
		setIconName("PHYLIPIcon.gif");
		setToolTip("PHYLIP File Format Options");
