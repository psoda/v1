/**
 *	PHYLIPStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of PHYLIP algorithms.
 *	
...
class PHYLIPStub extends DataConvert.Components.Stub
{
	//Class Variables - Created Objects
	private PHYLIPUsageBean bean;		//Bean created and populated by this class
	 ...
	 */
	public PHYLIPStub(String user_settingsFileName) throws IOException
	{
	 ...
	 */
	public PHYLIPStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new PHYLIPUsageBean();
	...
	{		
		...
		outputString += "[ PHYLIP User Input Values ]\n\n";
		outputString += "[ READER ]\n";
