/**
 *	PHYLIPUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the PHYLIP package.
 *	
...
class PHYLIPUsageBean extends DataConvert.Components.UsageBean
{
