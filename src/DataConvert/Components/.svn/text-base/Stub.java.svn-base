...
{	
	...
	public boolean getData(String user_settingsFileName)
	{
		...
		{
		//	(new UsageBean()).errorMessage("\nYou had an Exception while obtaining data from "+ user_settingsFileName +".");
			return false;
		}
	...
	/**
	 * Writes the data from bean to file
	 */
	public void writeSettings() throws IOException
	{		
		PrintWriter settings = new PrintWriter(new FileWriter(getBean().getInputFile()));	
		settings.println(writeData());
		settings.close();		
	}//writeSettings	
	...
	/**
	 * Resets and then writes the data from bean to file
	 */
	public void resetSettings() throws IOException
	{		
		PrintWriter settings = new PrintWriter(new FileWriter(getBean().getInputFile()));	
		settings.println(resetData());
		settings.close();		
	}//writeSettings	
