/**
 *	GENBANKXMLUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the GENBANKXMLXML package.
 *	
...
class GENBANKXMLUsageBean extends DataConvert.Components.UsageBean
{
