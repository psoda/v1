/**
 *	GENBANKXMLStub.class is an instantiated object that reads in 
 *	data and places them in a UsageBean that
 * 	contains all of the operational decisions a user can 
 *	make regarding the uses of GENBANKXML algorithms.
 *	
...
class GENBANKXMLStub extends DataConvert.Components.Stub
{
	//Class Variables - Created Objects
	private GENBANKXMLUsageBean bean;		//Bean created and populated by this class
	
	
	/**
	 * Empty Constructor, for utilization of this class's methods
	 */
	public GENBANKXMLStub(){}

	/**
	 * Constructor, creates an object to be referenced and utilized.
	 * It then calls methods to populate that object.
	 */
	public GENBANKXMLStub(String user_settingsFileName) throws IOException
	{
	 ...
	 */
	public GENBANKXMLStub(String user_settingsFileName, boolean errorWindow, String logFile) throws IOException
	{
		//create a new usage bean
		bean = new GENBANKXMLUsageBean();
	...
	{		
		...
		outputString += "[ GENBANKXML User Input Values ]\n\n";
		return outputString;
	}//writeData
