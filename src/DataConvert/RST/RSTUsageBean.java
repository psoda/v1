/**
 *	RSTUsageBean.class is an instantiated data object that
 *	contains all of the operational decisions a user can 
 *	make regarding the uses of the RST package.
 *	
...
class RSTUsageBean extends DataConvert.Components.UsageBean
{
