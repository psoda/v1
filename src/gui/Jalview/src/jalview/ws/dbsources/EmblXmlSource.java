...
public abstract class EmblXmlSource extends EbiFileRetrievedProxy
{
   ...
   * 
   * @param emprefx
   *                either EMBL or EMBLCDS strings are allowed - anything else
   *                will not retrieve emblxml
   * @param query
   * @return
   * @throws Exception
   */
          ...
          throws Exception
  {
    ...
    try
    {
      reply = dbFetch.fetchDataAsFile(emprefx.toLowerCase() + ":"
              + query.trim(), "emblxml", null);
    } catch (Exception e)
    {
      stopQuery();
