      ...
      if (res != null)
      {
        if (newWindow)
        {
          ...
          else
          {
             ...
             * input.getAlignmentAndColumnSelection(alignFrame.getViewport().getGapCharacter());
